...
İnce kariyer döngüsü (MVP: teknik direktör) + nabız→CTA + transfer CTA + **maç günü → HT → sonuç** + **sakatlık / iyileşme yolu** + **auto-swap** + **görsel XI şeridi** kilitlenmiştir (Bugün ↔ Ofis: **Hikâye** / **Hava** / **Not** + “Sıradaki”; gün ilerlemede **Not yenilendi** onayı). Futbolcu kariyeri ertelenmiştir (D-028). Uzun diyalog ağacı / kapsamlı gazeteci ağı açılmaz (D-118, `02_MVP_SCOPE`); D-150 transfer fiyat formüllerini açık bırakır. Sıradaki aday: sakin haftada tek satırlık staff fısıltısı (Bugün etiketi) veya Not yenilenince Ofiste kısa flash köprüsü.

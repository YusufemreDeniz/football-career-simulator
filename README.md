...
İnce kariyer döngüsü (MVP: teknik direktör) + **Transfer Masası** brifingi kilitlenmiştir. Futbolcu kariyeri ertelenmiştir (D-028). Sıradaki aday: nabızda transfer fokus veya maç sonrası karar derinliği; tam processing ledger / diyalog / gazeteci (D-150) henüz açılmamalıdır.

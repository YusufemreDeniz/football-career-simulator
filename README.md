...
İnce kariyer döngüsü + **sezon geçiş CTA (Bitir → Arşiv → Yeni sezon)** kilitlenmiştir. Sıradaki aday: Event & Rule iskeleti veya Match timeline; tam diyalog ağacı/gazeteci ağı ve ledger (D-150) henüz açılmamalıdır.

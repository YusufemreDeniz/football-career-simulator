...
İnce kariyer döngüsü + **Training Focus/Rest hub (Kondisyon/Toparlanma + dinlenme)** kilitlenmiştir. Sıradaki aday: Event & Rule iskeleti veya Match derinliği; tam diyalog ağacı/gazeteci ağı ve ledger (D-150) henüz açılmamalıdır.
